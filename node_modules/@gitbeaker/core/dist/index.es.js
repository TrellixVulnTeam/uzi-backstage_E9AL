...
function put(service, endpoint, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, service.requester.put(endpoint, {
                        body: body,
                        sudo: sudo,
                    })];
                case 1:
...
var ResourceAwardEmojis = /** @class */ (function (_super) {
    ...
    ResourceAwardEmojis.prototype.award = function (projectId, resourceId, noteId, name, options) {
        return RequestHelper.post(this, url$4(projectId, this.resourceType, resourceId, noteId), __assign({ name: name }, options));
    };
...
var url$3 = function (userId) { return (userId ? "users/" + encodeURIComponent(userId) + "/emails" : 'user/emails'); };
