...
function defaultOptionsHandler(serviceOptions, _a) {
    ...
    var options = requesterUtils.defaultOptionsHandler(serviceOptions, { body: body, query: query, sudo: sudo, method: method });
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (options.method === 'stream') {
                        ...
                        return [2 /*return*/, Got__default['default'](endpoint, options)];
                    }
                ...
                case 4:
                    ...
                    return [4 /*yield*/, requesterUtils.wait(waitTime)];
                case 5:
...
var APIServices = requesterUtils.modifyServices(services, { requesterFn: requesterFn });
var // Groups
