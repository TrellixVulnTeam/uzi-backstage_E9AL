 ...
 */
declare function schemaValidator(kind: string, apiVersion: readonly string[], schema: Schema<any>): KindValidator;

declare const API_VERSION: readonly ["backstage.io/v1alpha1", "backstage.io/v1beta1"];
declare const KIND: "API";
...
declare const KIND$1: "Component";
...
declare const API_VERSION$5: readonly ["backstage.io/v1alpha1", "backstage.io/v1beta1"];
declare const KIND$5: "Resource";
interface ResourceEntityV1alpha1 extends Entity {
    apiVersion: typeof API_VERSION$5[number];
    kind: typeof KIND$5;
    spec: {
        type: string;
        owner: string;
...
declare const API_VERSION$6: readonly ["backstage.io/v1alpha1", "backstage.io/v1beta1"];
declare const KIND$6: "System";
interface SystemEntityV1alpha1 extends Entity {
    apiVersion: typeof API_VERSION$6[number];
    kind: typeof KIND$6;
    spec: {
        owner: string;
        domain?: string;
...
declare const API_VERSION$7: readonly ["backstage.io/v1alpha1", "backstage.io/v1beta1"];
declare const KIND$7: "Template";
interface TemplateEntityV1alpha1 extends Entity {
    apiVersion: typeof API_VERSION$7[number];
    kind: typeof KIND$7;
    spec: {
        type: string;
        templater: string;
...
declare const API_VERSION$8: readonly ["backstage.io/v1beta2"];
declare const KIND$8: "Template";
interface TemplateEntityV1beta2 extends Entity {
    apiVersion: typeof API_VERSION$8[number];
    kind: typeof KIND$8;
    metadata: EntityMeta & {
        title?: string;
    };
...
declare const API_VERSION$9: readonly ["backstage.io/v1alpha1", "backstage.io/v1beta1"];
declare const KIND$9: "User";
interface UserEntityV1alpha1 extends Entity {
    apiVersion: typeof API_VERSION$9[number];
    kind: typeof KIND$9;
    spec: {
        profile?: {
            displayName?: string;
